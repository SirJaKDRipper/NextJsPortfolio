    ...
    <div className="bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row md:gap-2">
        <div className="md:w-3/4">
          <Image src={Developer1} alt="wallpaper" width={300} height={100} className="md:w-full md:max-w-md mx-auto ml-20" />
        </div>
        <div className="md:w-3/4 text-center md:text-left mt-5 md:mt-40 mr-40">
          <h1 className='text-2xl lg:text-3xl xl:text-lg italic mt-10 lg:-mt-10 xl:-mt-40 md:-mt-20 text-justify'>
      ...
      <div className="flex flex-col md:flex-row md:gap-2">
        <div className="md:w-3/4 text-center md:text-left mt-5 md:mt-40 mr-20">
          ...
          <h1 className='text-2xl lg:text-3xl xl:text-lg italic mt-10 lg:mt-10 md:-mt-20 ml-20 text-justify'>
        ...
        <div className="md:w-3/4">
          <Image src={Developer2} alt="wallpaper" width={300} height={100} className="md:w-full md:max-w-md mx-auto mt-40" />
        </div>
      </div>
